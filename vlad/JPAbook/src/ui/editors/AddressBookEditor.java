...
public class AddressBookEditor extends EditorPart {
	...
	private void editState() {
		...
		if ((contact.getFirstName().equals(firstNameText.getText()) == false
			...
			dataManager.updateContact(contact.getIdInt(), firstNameText.getText(), lastNameText.getText(),
					...
					adressText.getText(), postalCodeText.getText());
	...
	private void InsertState() {
		...
		if (isDirty() && regex.isEmailValid(emailAdressText.getText())
			...
			dataManager.insertContact(contact.getIdInt(), firstNameText.getText(), lastNameText.getText(),
					adressText.getText(), phoneNumberText.getText(), emailAdressText.getText(), countryText.getText(),
					cityText.getText(), postalCodeText.getText());
